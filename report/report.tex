...
range-and-bearing messages. Each robot broadcasts a phase tag and a beacon flag
through the local communication channel, so neighboring robots can estimate
whether they should follow a leader or bias their motion toward the target area.
This allows the swarm to coordinate locally without a centralized controller.
